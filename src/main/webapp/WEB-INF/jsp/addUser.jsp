					...
					<div class="pages">
						<table width="90%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td align="left"><input type="text" id="username" name="username" /><span
									style="color: red;">*</span><span id="span1" style="color: red;"></span></td>
							</tr>
							<tr>
...
<script type="text/javascript">
	...
	$(function(){
		$("#username").blur(
			function(){
				$.get(
					"${pageContext.request.contextPath}/user/checkUser",
					{"username":this.value},
					function(data){
						if(data!=null){
